...
This document defines the JSON schemas produced by the eval pipeline.

For `evals.json` (input) and `triggers.json` (input), see
[`evals-schema.md`](evals-schema.md). For `manifest.json` (per-iteration index),
